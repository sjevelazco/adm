#' TEST VERSION Fit and validate Convolutional Neural Network with exploration of hyper-parameters that optimize performance
#'
#' @param data 
#' @param response 
#' @param predictors 
  ...
  function(data,
    ...
    if (all(architectures != "fit_intern")){
      if (is.null(architectures)){
        ...
        architectures <- generate_arch_list(type="cnn",
