...
In this example we will use the first and seventh PC. Note that for `p_abund_pdp` and `p_abund_bpdp`, any subset of predictors can be used in the "predictors" argument. If "predictors" argument is NULL, functions plot all variables or variables pair combinations, respectively.
